<?php
require_once __DIR__ . '/../../Core/interfaces/Repo_interfaces/SchollarCycle.php';

class SchollarCycleRepository implements SchollarCycleInterface{
    private MySQLdatabase $mysql;
    private const TABLE = 'schollar_cycle';

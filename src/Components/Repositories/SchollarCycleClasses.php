<?php
require_once __DIR__ . '/../../Core/interfaces/Repo_interfaces/SchollarCycleClasses.php';

class SchollarCycleClassesRepository implements SchollarCycleClassesInterface{
    private MySQLdatabase $mysql;
    private const TABLE = 'schollar_cycle_classes';
